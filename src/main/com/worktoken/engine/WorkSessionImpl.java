...
public abstract class WorkSessionImpl implements WorkSession, Runnable {
    ...
    public WorkSessionImpl() {
        init(1L);
    }

    public WorkSessionImpl(long id) {
        init(id);
    }

    private void init(long id) {
        sessionId = id;
        SessionRegistry.getSessions().put(id, this);
